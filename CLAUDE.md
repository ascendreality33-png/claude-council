...
- **realist** (`yellow`, `sonnet`) — Delivers probability-weighted, base-rate-grounded assessments of the most likely outcome. Neither optimistic nor pessimistic — anchored to evidence and historical precedent.
